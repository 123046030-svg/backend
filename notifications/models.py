...
class EmailOutbox(Base):
    ...
    status: Mapped[str] = mapped_column(String(20), nullable=False, default="PENDING")  # PENDING|RETRY|SENT|FAILED
    ...
    context: Mapped[dict] = mapped_column(MySQLJSON, nullable=True)
